...
$conn = mysqli_connect("localhost", "root", "", "airline_surveys");
...
<body>
	...
	<form action="index.php" method="POST">
		<p>
			<input type="text" name="date" placeholder="Date and time of flight" required />
		</p>
		<p>
			<input type="number" name="flightID" placeholder="Flight ID" required />
		</p>

		<h2>Friendliness of customer staff:</h2>
		<p>
			<input type="radio" name="friendliness" value="No opinion" id="friendliness1" checked />
		...
		<p>
			<input type="radio" name="space" value="No opinion" id="space1" checked />
		...
		<p>
			<input type="radio" name="comfort" value="No opinion" id="comfort1" checked />
		...
		<p>
			<input type="radio" name="cleanliness" value="No opinion" id="cleanliness1" checked />
		...
		<p>
			<input type="radio" name="noise" value="No opinion" id="noise1" checked />
